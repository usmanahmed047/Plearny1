...
namespace POPBlocks.Scripts.GameGUI.BonusSpin
{
    ...
    public class BonusSpin : Popup
    {
        ...
        void OnEnable()
        {
            ...
            bonusSpinButton = FindObjectOfType<BonusSpinButton>();
...
// #endif
        ...
        IEnumerator Spinning()
        {
            ...
            CheckSpin();
            //OnSpin?.Invoke();
            bonusSpinButton.OnSpinEvent.Invoke();
            Hide();
        }
        ...
        {
            FindObjectOfType<BonusSpinButton>().gameObject.GetComponent<Canvas>().enabled = true;
        }
    }
}